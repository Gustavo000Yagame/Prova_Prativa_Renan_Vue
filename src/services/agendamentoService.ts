...
// Ela deve fazer uma requisição GET à API e retornar a lista de agendamentos.
...
// Ela recebe um "id" do tipo number e deve retornar um único agendamento.
...
// e deve fazer uma requisição POST à API.
